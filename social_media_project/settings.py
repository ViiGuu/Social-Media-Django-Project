...
SECRET_KEY = 'django-insecure-%%(%^+g08o(52bhyr1kuze6*1j7fbj0xx#q1kht8guvxecgwif'
...
MIDDLEWARE = [
    ...
    'users_app.middleware.UserTimeoutMiddleware'
]
...
# i have bcrypt and django[argon2] installed on my venv
PASSWORD_HASHERS = [ 
